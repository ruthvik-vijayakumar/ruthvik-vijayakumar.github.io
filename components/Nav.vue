<template>
  ...
  >
    <div>
      ...
      <section class="mt-8">
        <a
          class="inline-flex items-baseline font-medium leading-tight text-teal-200 hover:text-teal-300 focus-visible:text-teal-300 font-semibold text-slate-200 group/link text-base"
          href="https://gwu.box.com/shared/static/rs84yv3bhrudy2bggn51g9i3rfg15eqb.pdf"
          target="_blank"
          ...
          <span>
            ...
            <span class="inline-block ">
              ...
              <svg
                ...
                viewBox="2 2 20 20"
                fill="currentColor"
                class="inline-block h-5 w-5 shrink-0 transition-transform group-hover/link:-translate-y-1 group-hover/link:translate-x-1 group-focus-visible/link:-translate-y-1 group-focus-visible/link:translate-x-1 motion-reduce:transition-none translate-y-px"
                aria-hidden="true"
              >
                <path
                  fill-rule="evenodd"
    ...
    <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
      <li class="mr-5 text-xs shrink-0">
        <a
          ...
          href="https://github.com/coderuth"
          target="_blank"
          rel="noreferrer noopener"
      ...
      <li class="mr-5 text-xs shrink-0">
        <a
          class="block hover:text-slate-200"
          href="https://www.linkedin.com/in/coderuth/"
          target="_blank"
          rel="noreferrer noopener"
      ...
      <li class="mr-5 text-xs shrink-0">
        <a
          class="block hover:text-slate-200"
          href="https://instagram.com/coderuth"
          target="_blank"
          rel="noreferrer noopener"
      ...
      <li class="mr-5 text-xs shrink-0">
        <a
          class="block hover:text-slate-200"
          href="https://twitter.com/coderuth"
          target="_blank"
          rel="noreferrer noopener"
